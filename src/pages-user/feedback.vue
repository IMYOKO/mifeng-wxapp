<template>
  <view>
    <view class = "content">
      <textarea placeholder="* 我们懂得聆听，请在此写下您的建议" maxlength = "200" placeholder-class = "input-placeholder" @input = "inputContent"></textarea>
      <view class = "num"><text>{{contentLength}}</text>/200</view>

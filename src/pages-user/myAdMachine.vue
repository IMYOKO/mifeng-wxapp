<template>
  <view class="myAdMachine">
    <view class = "ct-view" v-for="(item, index) in contentList" :key="index" @tap="clickDetail">
      <image class = "status" src=  "../static/images/pic_my_advertising_machine_on_line.png" v-if="item.online_status == 'online'"/>
      <image class = "status" src=  "../static/images/pic_my_advertising_machine_off_line.png" v-else-if ="item.online_status == 'offline'"/>
      <view class = "ct">
